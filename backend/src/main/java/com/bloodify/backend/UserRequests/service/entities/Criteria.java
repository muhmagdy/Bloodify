...
public class Criteria {
    ...
    // Potential donors are those who have: status = 0 (don't have request), no
    // diseases
    ...
    public List<User> filterOnDistance(List<User> potentialDonors, Double instLongitude, Double instLatitude,
            int threshold) {
